...
BOT_TOKEN = getenv("BOT_TOKEN", "5903136891:AAHIuIvAmCGP8N4NwAr6YmEvp-HYJPbRYHY")
CLONER_TOKEN = getenv("CLONER_TOKEN")
BOT_NAME = getenv("BOT_NAME", "")
BOT_USERNAME = getenv("BOT_USERNAME", "Musiccloner_Bot")
...
BG_IMG = getenv("BG_IMG", "https://telegra.ph/file/cefd3211a5acdcd332415.jpg")
